<?php $__env->startSection('rightcard'); ?>
        ...
        <h1 style="text-align: left"><span id="issue_id" class="badge badge-secondary">Issue #<?php echo e($issueID); ?>.<?php echo e($updateNumber); ?></span> <span id="name" class="badge badge-secondary"><?php echo e($name); ?> <?php echo e($surname); ?></span></h1>
        <div class="row" style="padding-top: 2em; padding-bottom: 1em;">
              <div id="user_pane" class="col-4">
                    <ul class="list-group" style="text-align: left;">
                            <div id="user_info">                                             
                                <li class="list-group-item border-0"><i class="fas fa-user" style="padding-right: 1em;"></i><?php echo e($employeeID); ?> <?php echo e($name); ?> <?php echo e($surname); ?></li>
